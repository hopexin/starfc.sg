...
// STAR FC 博客索引（唯一维护入口）
// =====================================================================
// 首页"最新文章"与 blog/index.html 都由本文件驱动（新→旧排序自动）。
  ...
  posts: [
    {
      ...
      "excerptZh": "经过风雨二十载，STAR FC 凭借成员之间的深厚情谊和传帮带精神，始终渡过难关，并不断发展壮大。",
      "excerptEn": "Through two decades of change, STAR FC has kept growing through friendship, mentorship and a shared love of football.",
      "tagZh": "队史档案",
      "tagEn": "Club Archive",
